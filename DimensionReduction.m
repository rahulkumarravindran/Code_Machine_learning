...
[mappedData,mapping]= compute_mapping(data_f(:,1:n-1),"CCA",10,3);
...
[mappedData,mapping] = compute_mapping(data_f(:,1:n-1),"MVU",10,3);
...
[mappedData,mapping] = compute_mapping(data_LMVU(:,1:n-1),"LandmarkMVU",3,2);
